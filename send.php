  ...
  <header>
    <div class="container">
      ...
      <div class="header-right">
        ...
        <a href="performance.html">実績</a>
        <a href="contact.html">採用</a>
        <a href="contact.html">お問合せ</a>
      </div>
      <div id="header-right-mobile">
        <span class="fa fa-bars" id="menu-icon"></span>
        <div id="menu">
          <a class="menu-btn" href="#aboutCompany">会社概要</a>
          <a class="menu-btn" href="ceoComent.html">代表挨拶</a>
          <a class="menu-btn" href="performance.html">実績</a>
          <a class="menu-btn" href="contact.html">採用</a>
          <a class="menu-btn" href="contact.html">お問合せ</a>
        </div>
